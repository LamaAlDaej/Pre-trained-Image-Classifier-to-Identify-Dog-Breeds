...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        ...
        #
        # All percentages in results_stats_dic have 'keys' that start with the letter p.
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            # index 2 = 1/0 (int)  where 1 = match between pet image and classifer labels and 0 = no match between labels
